...
n_pasos=10
n_repeticiones=10
tam_inicio=$((100000000*p))
tam_paso=100000000
tam_final=$((100000000*(p+10)))
f_dat_tiempos=graficas/tiempos_par
...
plot "$f_dat_tiempos.dat" using 1:2 with lines lw 2 title "Parallel (1)", \
    "$f_dat_tiempos.dat" using 1:3 with lines lw 2 title "Parallel (2)", \
    "$f_dat_tiempos.dat" using 1:4 with lines lw 2 title "Parallel (3)", \
    "$f_dat_tiempos.dat" using 1:5 with lines lw 2 title "Parallel (4)"
replot
quit
END_GNUPLOT